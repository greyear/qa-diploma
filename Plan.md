...
2) Перейти на страницу http://localhost:8080/
3) Нажать на кнопку "Купить"
4) Заполнить поле "Месяц" невалидным значением - h*
...
2) Перейти на страницу http://localhost:8080/
3) Нажать на кнопку "Купить"
4) Заполнить поле "Год" невалидным значением - Р?
...
Ожидаемый результат: Под полем "CVC/CVV" высвечивается ошибка валидации: "Поле обязательно для заполнения". Под другими полями уведомлений не возникает.
...
2) Перейти на страницу http://localhost:8080/
3) Нажать на кнопку "Купить"
4) Заполнить поле "CVC/CVV" невалидным значением - *Ц?
